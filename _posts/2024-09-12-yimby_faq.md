...
<!-- see also: induced demand, chicken and egg -->
...
<!-- With rent control, don't landlords just raise the rent on turnover? so vacancy chains make rents go up -->
<!-- Landlords raise rents when demand increases faster than supply; rent control merely redirects this demand pressure to turnover, instead of addressing the root problem.

1) The cheapest housing is people sharing a unit as roommates; when a vacancy chain frees up a bedroom, the rent does not go up, because the unit is not vacated. 
2) From a renter's perspective, it's better to have a vacant unit, even if rent is higher than what the previous tenant paid, than to have an unavailable unit. So building new market-rate housing is better than doing nothing.
-->
...
<!-- raises question of induced demand -->

<!-- # gentrification -->
<!-- I think of gentrification as increasing demand to live in a neighborhood. If we build new housing, the neighborhood grows. If not, the rich newcomers outbid current residents, so we get displacement. -->
...
<!-- single-family land values are actually too low, because they're developers can't buy them
but apartment-zoned land is artificially expensive -->

<!-- when prices > costs, value is capitalized in land -->

# Isn't upzoning a giveaway to developers?

<!-- No, if anything it's a giveaway to homeowners, since it allows them to sell to developers for bags of cash. -->

# Inclusionary zoning

<!-- funding subsidized housing by cannibalizing market-rate housing doesn't work -->
<!-- land value capture is backwards: should be taxing homeowners, not developers -->

<!-- what would a sneaky NIMBY do? pretend to care about affordability, impose costs on apartments that make any projects financially infeasible
the purpose of a system is what it does: affordability requirements block housing  -->
...
<!-- and we don't see the projects that never start because fees make them infeasible; key problem, harmful effects are invisible -->
...
<!-- https://x.com/michael_wiebe/status/1836189744885305623 -->
...
<!-- supply and demand together: increasing demand, restricted supply -->
...
<!-- devious trick: block housing, drive up prices, force poor people out, so they can't even vote on city housing policy -->
<!-- principle of affected interests, kogelmann -->

<!-- but by this logic, why not let everyone in the world vote on my neighborhood's zoning policy?
