...
![Shares of $$\hat{\beta}_{1,k}$$ and robustness](https://michaelwiebe.com/assets/b0_shares_signif.png)
...
<!-- robustness][{label="fig1"}](https://michaelwiebe.com/assets/bhet_shares.png){#fig1} -->
robustness](https://michaelwiebe.com/assets/bhet_shares.png)

<!-- As shown in Figure [\[fig1\]](#fig1){reference-type="ref" reference="fig1"}, when $$\gamma$$ is small, most of the weight in -->
