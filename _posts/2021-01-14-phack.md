...
![Shares of $$\hat{\beta}_{1,k}$$ and robustness](https://michaelwiebe.com/assets/p-hack_robust/table1.png)
...
Footnotes
---------
See [here]((https://michaelwiebe.com/assets/p-hack_robust/p-hack.r)) for R code.
