...
![Shares of $$\hat{\beta}_{1,k}$$ and robustness](https://michaelwiebe.com/assets/b0_shares_signif.pdf){#fig0}
...
robustness][{label="fig1"}](https://michaelwiebe.com/assets/bhet_shares.pdf){#fig1}
