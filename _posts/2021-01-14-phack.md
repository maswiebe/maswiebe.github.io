...
Economists want to show that our results our robust. Consider Table 1 below: Column 1 contains the baseline model, with no covariates, and Column 2 controls for $$z$$. Because the coefficient on $$X$$ is stable and significant across columns, we say that our result is robust.

![](https://michaelwiebe.com/assets/p-hack_robust/table1.png)
![](https://michaelwiebe.com/assets/p-hack_robust/test.png)
...
![Shares of $$\hat{\beta}_{1,k}$$ and robustness](https://michaelwiebe.com/assets/p-hack_robust/b0_shares_signif.png)
*Shares of $$\hat{\beta}_{1,k}$$ and robustness*
...
![Shares of $$\hat{\delta}_{1,k}$$ and robustness](https://michaelwiebe.com/assets/p-hack_robust/bhet_shares.png)
...
Footnotes
---------
See [here](https://michaelwiebe.com/assets/p-hack_robust/p-hack.r){:target="_blank"} for R code.
