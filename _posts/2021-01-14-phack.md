...
![Shares of $$\hat{\beta}_{1,k}$$ and robustness](https://michaelwiebe.com/assets/b0_shares_signif.png){:height="120%" width="120%"}
...
![Shares of $$\hat{\delta}_{1,k}$$ and robustness](https://michaelwiebe.com/assets/bhet_shares.png)
